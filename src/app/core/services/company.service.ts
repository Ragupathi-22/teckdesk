...
import { AssetStatus, Company, OperatingSystem, Team, TicketCategory, TicketStatus } from '../../core/models/company.models';
  ...
  private async fetchCompanies() {
    ...
    try {
      ...
      const companies: Company[] = snap.docs.map((d) => {
        ...
        const operatingSystems: OperatingSystem[] = Array.isArray(data.operatingSystems)
          ? data.operatingSystems
            .filter((t: OperatingSystem) => t.isActive)
            .sort((a: OperatingSystem, b: OperatingSystem) => a.sortOrder - b.sortOrder)
          : [];
